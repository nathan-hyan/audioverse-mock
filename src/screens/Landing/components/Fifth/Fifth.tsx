  ...
  return (
    <motion.div className={styles.container}>
      ...
      <motion.p>
        ...
        también tienes la opción de actualizarlos cada tres años por los modelos
        más recientes. Si lo prefieres, puedes conservar tu equipo actual y
        seguir disfrutando de un sonido excepcional, diseñado para durar.
      </motion.p>
